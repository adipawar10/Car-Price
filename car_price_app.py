...
@st.cache()
#streamlit.set_page_config(page_title ="Car Predictor", page_icon ="random", layout = 'centered', initial_sidebar_state = 'auto')
def load_data():
...
import predict
import plot
pages_dict={"Home":main,"View Data":data,"Plot":plot,"Predict":predict}
